...
export class CourseService {
  ...
  addCourse(image: string,
            ...
            description: string,
            rate: number) {
    this.coursesRef.push(this.createCourse(image, name, ects, term, activities, maxStudents, description, rate));
  }
  updateCourse(id: string, image: string,
               name: string,
               ects: number,
               term: number,
               activities: string,
               ...
               description: string,
               rate: number) {
    this.coursesRef.update(id, this.createCourse(image, name, ects, term, activities, maxStudents, description, rate));
  }
